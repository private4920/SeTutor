...
function getFirebaseApp() {
    if (firebaseApp === null) {
        const existingApps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApps"])();
        firebaseApp = existingApps.length === 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeApp"])(firebaseConfig) : existingApps[0];
    }
    return firebaseApp;
}
function getFirebaseAuth() {
    if (auth === null) {
        auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuth"])(getFirebaseApp());
    }
    return auth;
}
...
"[project]/src/lib/firebase/AuthContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(auth, {
                ...
                "AuthProvider.useEffect.unsubscribe": (err)=>{
    ...
    const signInWithGoogle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signInWithGoogle]": async ()=>{
            ...
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithPopup"])(auth, provider);
            } catch (err) {
...
_s(AuthProvider, "kswm2MKfoB3Ut6Gq6Yr2oHPeXBU=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
function ToastProvider({ children }) {
    ...
    const addToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ToastProvider.useCallback[addToast]": (type, message, duration = 5000)=>{
...
_s1(ToastProvider, "7cBV1UF+RhXv7V5n22in6Hfk4C4=");
_c = ToastProvider;
...
function ToastItem({ toast, onRemove }) {
    ...
    const handleRemove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ToastItem.useCallback[handleRemove]": ()=>{
            setIsExiting(true);
            setTimeout({
                "ToastItem.useCallback[handleRemove]": ()=>onRemove(toast.id)
            }["ToastItem.useCallback[handleRemove]"], 200);
        }
    }["ToastItem.useCallback[handleRemove]"], [
        onRemove,
        toast.id
        ...
        "ToastItem.useEffect": ()=>{
            if (toast.duration && toast.duration > 0) {
                const exitTimer = setTimeout({
                    "ToastItem.useEffect.exitTimer": ()=>setIsExiting(true)
                }["ToastItem.useEffect.exitTimer"], toast.duration - 200);
                return ({
                    "ToastItem.useEffect": ()=>clearTimeout(exitTimer)
                })["ToastItem.useEffect"];
            }
            return undefined;
        }
...
_s2(ToastItem, "FI0eteFyv83J3+I5Rd6fKClsHDM=");
_c2 = ToastItem;
var _c, _c1, _c2;
...
//# sourceMappingURL=src_455446ad._.js.map